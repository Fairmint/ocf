...
**Description:** _JSON file schema defining a list of valuation objects used in cap tables. Each object includes effective date, stock class ID, valuation type, and price per share, among other fields._
